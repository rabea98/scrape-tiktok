...
class UsersSpider(scrapy.Spider):
    ...
    start_urls = ['https://tikrank.com/influencer/influencers?page_num=1&page_size=10000&sorted_by=followers&country=DE&fans_count=0&keyword=&order=desc', 'https://tikrank.com/influencer/influencers?page_num=1&page_size=10000&sorted_by=followers&country=ES&fans_count=0&keyword=&order=desc']
